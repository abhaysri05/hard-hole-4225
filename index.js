function firstBlock() {
    ...
    drop.addEventListener("mouseover", function () {
      ...
      drop.addEventListener("mouseout", function () {
        ...
        document.querySelector(".shop-category").style.borderBottom = "5px solid white";
      });
    });
  ...
  function secondBlock() {
    ...
    drop.addEventListener("mouseover", function () {
      ...
      drop.addEventListener("mouseout", function () {
        drop.style.display = "none";
        document.querySelector(".best-seller").style.borderBottom = "5px solid white";
      });
    });
  ...
  function thirdBlock() {
    document.querySelector(".brands").addEventListener("mouseover", () => {
      ...
      drop.style.width = "40%";
      drop.style.justifyContent = "space-around";
      document.querySelector(".brands").style.borderBottom =
        "5px solid #77777e";
    });
    let drop = document.querySelector(".drop-brands");
    drop.addEventListener("mouseover", function () {
  ...
  function fourthBlock() {
    document.querySelector(".deals").addEventListener("mouseover", () => {
      ...
      drop.style.width = "40%";
      drop.style.justifyContent = "space-around";
      document.querySelector(".deals").style.borderBottom =
        "5px solid #77777e";
    });
    let drop = document.querySelector(".drop-deals");
    drop.addEventListener("mouseover", function () {
  ...
  var dropdownTop = document.getElementsByClassName("hover-li")
...
fetchApi("https://healthkart-render-api.onrender.com/allproducts/flashsale");
...
function createDom(data) {
  ...
  data.forEach((element)=>{
    ...
    oldprice.setAttribute("id","dc-price");
    newprice.setAttribute("id","sell-price")
    ...
    premiumprice1.innerText = "🌟"+ "₹"+ element.premium_price + "  for Premium Members";
